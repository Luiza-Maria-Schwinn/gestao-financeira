 ...
 */
public class TelaDashboardEmpresa extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaDashboardEmpresa
     */
    public TelaDashboardEmpresa() {
        initComponents();
    ...
    private boolean salvarTransacaoNoBanco(Transacao transacao) {
        try (Connection conn = ConfiguracaoBD.getConnection()) { 
            ...
            JOptionPane.showMessageDialog(null, "Erro ao salvar transação no banco de dados: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
            return false;
    ...
    public void carregarTransacoesDoBanco() {
        ...
        try (Connection conn = ConfiguracaoBD.getConnection()) { 
            ...
            JOptionPane.showMessageDialog(null, "Erro ao carregar transações do banco: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDashboardEmpresa().setVisible(true);
            }
        });
    }
